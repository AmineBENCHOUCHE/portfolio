...
const RecentProjects = () => {
    return (
        <div className='py-20'>
            ...
            {/* //Projects cards */}
            <div id="projects" className='flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-8 mt-10'>
                {projects.map(({ id, title, des, link, img, iconLists }) => (
                    <div key={id} className="lg:min-h-[32.5rem] h-[32rem] sm:h-[41rem] flex items-center justify-center sm:w-[570px] w-[80vw]">
                        <PinContainer title={link} href={link}>
                            {/* //To see the cards  you must implement the width anh height */}
                            <div className='relative flex items-center justify-center sm:w-[570px]  w-[80vw] overflow-hidden sm:h-[40vh] h-[30vh] mb-10'>
                                ...
                                <img src={img} alt={title} className='absolute z-10 bottom-0 w-40 h-40' />
                                </div>
