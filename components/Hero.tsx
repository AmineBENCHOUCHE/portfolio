...
const Hero = () => {
    return (
        <div className='pb-20 pt-36'>
            ...
            {/*TODO replace by dot instead of grid*/}
            <BackgroundGrid />
            ...
            <div className='flex justify-center relative my-20 z-10'>
                <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
                    ...
                    <TextGenerateEffect className='md:text-5xl lg:text-6xl text-center text-[40px]' words="Transforming Concepts into Seamless User Experiences" />
                    <p className='text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl'>Hi! I&apos;m Amine a NextJS Developer based in France</p>
                    <a href="#about">
